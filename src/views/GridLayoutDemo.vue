...
import TestElement from '../components/vue-grid-layout/TestElement.vue';
import CustomDragElement from '../components/vue-grid-layout/CustomDragElement.vue';
...
<style lang="scss">
@import "src/assets/css/grid-layout";
#app {
  font-family: 'Avenir', Helvetica, Arial, sans-serif;
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
